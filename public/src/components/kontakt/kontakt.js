...
class Kontakt extends Component {
	...
	render() {
		...
		return(<div className="kontakt-container">
			...
			<li>E-mail: <span style={{fontWeight: "bold"}}><a style={{ color: "black", textDecoration: "none" }} aria-label="mail-to" className="mail-to" href="mailto:mirza@kravmagatuzla.ba" target="_blank" rel="noopener noreferrer">mirza@kravmagatuzla.ba</a></span></li>
			<li>Preko kontakt forme</li>
			<li><span style={{fontWeight: "bold"}}><a style={{ color: "black", textDecoration: "none" }} aria-label="mail-to" className="mail-to" href="https://www.facebook.com/408588132922283/" target="_blank" rel="noopener noreferrer" >Facebook</a></span> ili <span style={{fontWeight: "bold"}}><a style={{ color: "black", textDecoration: "none" }} aria-label="mail-to" className="mail-to" href="https://www.instagram.com/krav_maga_tuzla/" target="_blank" rel="noopener noreferrer">Instagram</a></span></li>
			</ul>	
